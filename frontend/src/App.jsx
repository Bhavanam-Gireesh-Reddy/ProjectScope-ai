  ...
  return (
    <div className="min-h-screen bg-[#0a0f1c] text-slate-200 selection:bg-primary/30 font-sans">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 relative z-10 flex flex-col items-center">
        ...
        {/* Header Hero */}
        <div className={`transition-all duration-700 w-full flex flex-col items-center justify-center ${data || viewMode === 'history' ? 'mt-4 mb-10' : 'mt-32 mb-12'}`}>
          <div className="flex items-center gap-4 mb-6">
            ...
            <button 
              ...
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-800 text-slate-300 border border-slate-700 hover:bg-slate-700 hover:text-white transition-all shadow-sm text-sm font-medium"
            >
              {viewMode === 'search' ? (
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-center mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-indigo-200 to-primary">
            ProjectScope AI
          </h1>
